...
function laborator_init()
{
	...
	wp_register_script('aurum-custom', THEMEASSETS . 'js/aurum-custom.js', null, null, true);
	wp_register_script('aurum-contact', THEMEASSETS . 'js/aurum-contact.js', null, null, true);
...
<div class="wrap">
	...
	<p>
		<a href="http://documentation.laborator.co/kb/item/aurum/" class="button button-primary" id="lab_read_docs">Read Documentation</a>
	</p>
...
function aurum_plugins()
{
	$plugins = array(
		...
		array(
			'name'               => 'Layer Slider',
			'slug'               => 'LayerSlider',
			'source'             => get_template_directory() . '/inc/thirdparty-plugins/layersliderwp-5.4.0.installable.zip',
			'required'           => false,
			'version'            => '5.4.0',
		),
		...
		array(
			...
			'source'             => get_template_directory() . '/inc/thirdparty-plugins/envato-wordpress-toolkit.zip',
		),
