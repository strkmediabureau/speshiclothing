...
global $post, $product, $post_cloned, $product_cloned;
...
if(count($product_images) && $item_preview_type != 'none'):
	...
	if(in_array($item_preview_type, array('fade', 'slide'))):
		...
		if($attachment = wp_get_attachment_image_src($attachment_id, apply_filters('laborator_wc_product_loop_thumb_size', 'shop-thumb')))
		{
