...
<div class="product-item">
	...
	<div class="product-link">
		<?php if($product->is_type('simple') && $product->is_in_stock()): ?>
			<a class="btn btn-default btn-xs add-to-cart ajax-add-to-cart ajax-require-refresh" data-product-id="<?php echo $product->id; ?>" href="<?php the_permalink(); ?>" data-toggle="tooltip" data-placement="left" title="<?php echo $button_text; ?>" data-added-to-cart-title="<?php _e('Product added to cart!', 'woocommerce'); ?>"><?php _e('Add to cart', 'aurum'); ?></a>
